...
var vision_service_1 = require("./vision.service");
...
var AppModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [search_controller_1.SearchController, vision_controller_1.VisionController],
            providers: [
                search_service_1.SearchService,
                vision_service_1.VisionService,
                {
                    provide: common_2.Logger,
                    useValue: new common_2.Logger('SearchModule'),
                },
            ],
        })];
