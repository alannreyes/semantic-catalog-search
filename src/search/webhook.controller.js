...
var WebhookController = function () {
    ...
    var WebhookController = _classThis = /** @class */ (function () {
        function WebhookController_1(searchService) {
        ...
        WebhookController_1.prototype.webhookSearch = function (id, query, limit, segment) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error("Webhook search error: ".concat(error_1.message));
    ...
    (function () {
        ...
        _webhookSearch_decorators = [(0, common_1.Get)(':id')];
